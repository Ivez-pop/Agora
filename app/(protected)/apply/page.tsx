...
import { getActiveCohort, parseAnswers, parseQuestions } from "../../../lib/cohorts";
      ...
      <section className="app-card">
        ...
        {searchParams?.error ? (
          <p className="form-message error">
            {searchParams.error === "cohort-changed"
              ? "The cohort changed while you were applying. Review the questions and resubmit."
        ...
        {isRejected ? (
          ...
          <>
            ...
            <div className="application-summary">
              ...
              {/* Applications submitted before cohorts have no questions — read their legacy fields. */}
              {questions.length === 0 ? (
                <>
                  <p>
